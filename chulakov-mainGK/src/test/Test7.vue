<template>
  <div class="background-container">
    ...
    <div class="language-selection">
      ...
      <button class="language-button" @click="wrong()">Student</button>
      <button class="language-button" @click="correct()">Teacher</button>
      <button class="language-button" @click="wrong()">Lesson</button>
