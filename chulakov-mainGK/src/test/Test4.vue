<template>
  <div class="background-container">
    ...
    <div class="language-selection">
      ...
      <button class="language-button" @click="correct()">White</button>
      <button class="language-button" @click="wrong()">Three</button>
      <button class="language-button" @click="wrong()">Soccer</button>
