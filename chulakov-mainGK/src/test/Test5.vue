<template>
  <div class="background-container">
    ...
    <div class="language-selection">
      ...
      <button class="language-button" @click="wrong()">Dog</button>
      <button class="language-button" @click="correct()">Cat</button>
      <button class="language-button" @click="wrong()">Ball</button>
